...
export default function PlanPurchaseModal({ plan, onClose }: PlanPurchaseModalProps) {
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-md rounded-xl bg-white p-8 shadow-2xl border border-slate-200"
      ...
      >
        ...
        <h2 id="modal-title" className="text-2xl font-bold text-slate-900 mb-2 tracking-tight">
          Solicitar {plan.name}
        </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              className="flex-1 py-3 rounded-lg font-semibold flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20BD5A] text-white transition-colors"
            >
